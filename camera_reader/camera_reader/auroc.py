...
class ArucoMarkerNode(Node):
    def __init__(self):
        ...
        self.image_subsrciber = self.create_subscription(
        ...
        self.aruco_dict= cv2.aruco.Dictionary(cv2.aruco.DICT_ARUCO_ORIGINAL)
    ...
    def image_callback(self,msg:Image):
        ...
        corners, ids, rejected = cv2.aruco.drawDetectedMarkers(
            gray_image, self.aruco_dict,self.aruco_params
        )
        if ids is not None:
